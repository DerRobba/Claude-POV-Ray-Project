// ============================================================================
//  car_drive.pov  -  "Sunday Drive through POV-Ray Valley"
// ----------------------------------------------------------------------------
...
//  Render it with the [Car Drive ...] entries I added to quickres.ini, or with
//  car_drive.ini that sits next to this file.
//
